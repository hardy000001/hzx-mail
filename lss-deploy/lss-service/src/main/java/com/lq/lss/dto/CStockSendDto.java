...
public class CStockSendDto{
    ...
    private List<CStockSendDetailDto>   cStockSendDetailDto;
...
public List<CStockSendDetailDto> getcStockSendDetailDto() {
	return cStockSendDetailDto;
}
public void setcStockSendDetailDto(List<CStockSendDetailDto> cStockSendDetailDto) {
	this.cStockSendDetailDto = cStockSendDetailDto;
}
