 ...
 * @since 2016-08-31
 */
public class CStockInfo extends EasyUiModel<Integer>{
	...
	/** 调拨库存总数量 **/
    private BigDecimal transfertotalS;
    ...
    */
   public BigDecimal getTransferTotalS() {
       return transfertotalS;
   }
   /**
    * 设置属性:transfertotalS
    * 调拨库存总数量
    * @param transfertotalS
    */
   public void setTransferTotalS(BigDecimal transfertotalS) {
       this.transfertotalS = transfertotalS;
   }
