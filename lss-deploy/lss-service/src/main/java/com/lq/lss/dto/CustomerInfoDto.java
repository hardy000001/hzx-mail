...
public class CustomerInfoDto{
    ...
    private List<CustomerRentinfoDto> customerRentinfoDtos;
   ...
   public void setCreatetime(String createtime) {
	...
	public List<CustomerRentinfoDto> getCustomerRentinfoDtos() {
		return customerRentinfoDtos;
	}
	public void setCustomerRentinfoDtos(
			List<CustomerRentinfoDto> customerRentinfoDtos) {
		this.customerRentinfoDtos = customerRentinfoDtos;
	}
