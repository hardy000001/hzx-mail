 ...
 */
@Controller
@RequestMapping(value = "/user/stock/transferout.htm")
public class TransferOutController extends ShiroBaseController<CStockTransfer, String, StockTransferService> {
    ...
    public ModelAndView index(HttpServletRequest request, HttpServletResponse response) {
        ...
        modelMap.put("add", PermResourceConst.CENTER_TRANS_OUT_ADD);
        modelMap.put("update", PermResourceConst.CENTER_TRANS_OUT_UPDATE);
        modelMap.put("del", PermResourceConst.CENTER_TRANS_OUT_DEL);
        modelMap.put("check", PermResourceConst.CENTER_TRANS_OUT_CHECK);
    ...
    @RequiresPermissions(PermResourceConst.CENTER_TRANS_OUT_DEL)
    ...
    public ModelAndView queryTransferDetail(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            adminAuditLogService.log(sessionUser.getUserId(), TradeType.STOCK_TRANSFER_OUT.getType(), "删除了中心内部调出单", tsfSerialNo, 0L);
    ...
    @RequiresPermissions(PermResourceConst.CENTER_TRANS_OUT_CHECK)
    public ModelAndView audit(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            stockTransferService.auditStockTransferOutByIdRdTx(cStockTransfer);

            adminAuditLogService.log(sessionUser.getUserId(), TradeType.STOCK_TRANSFER_OUT.getType(), "审核了中心内部调出单", cStockTransfer, 0L);
    ...
    @RequestMapping(params = "method=antiAuditTraOut")
	@RequiresPermissions(PermResourceConst.CENTER_TRANS_OUT_CHECK)
	public ModelAndView antiAuditTraOut(HttpServletRequest request,HttpServletResponse response) {
		...
		try {
			...
			result=stockTransferService.antiAuditStockTransferOutByIdRdTx(cStockTransfer);
