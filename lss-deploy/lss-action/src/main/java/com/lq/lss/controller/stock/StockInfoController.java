 ...
 */
@Controller
@RequestMapping(value = "/user/stock/stockinfo.htm")
public class StockInfoController extends EasyUIController<CStockInfo, Integer,StockInfoService > {
