 ...
 */
@Controller
@RequestMapping(value = "/user/print/stockCentertransferPrintIn.htm")
public class StockCentertransferInPrintController extends
	...
	@Value("/print/stock_centertransfer_printin")
