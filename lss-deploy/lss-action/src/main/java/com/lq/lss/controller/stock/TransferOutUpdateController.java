 ...
 */
@Controller
@RequestMapping(value = "/user/stock/transferOutUpdate.htm")

public class TransferOutUpdateController extends ShiroBaseController<CStockTransfer, String, StockTransferService> {
    ...
    @Value("/stock/transfer_out_update")
    ...
    @RequiresPermissions(PermResourceConst.CENTER_TRANS_OUT_UPDATE)
    @Override
    public ModelAndView save(HttpServletRequest request, HttpServletResponse response) {
        ...
        System.out.println("toMchId"+toMchId);
