 ...
 */
@Controller
@RequestMapping(value = "/user/print/transferinPrint.htm")
public class StockTransferInPrintController extends
	...
	private List<CStockTransferDetail> totalInList(List<CStockTransferDetail> detailList)
	{
