 ...
 */
@Controller
@RequestMapping(value = "/user/stock/stockInAdd.htm")
public class StockInAddController extends EasyUIController<CStockIn, String, StockInService> {
	...
	@RequiresPermissions(PermResourceConst.CENTER_IN_ADD)
	@Override
