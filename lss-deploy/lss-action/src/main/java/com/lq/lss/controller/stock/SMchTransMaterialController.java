 ...
 */
@Controller
@RequestMapping(value ="/user/stock/smchtransmaterial.htm")
public class SMchTransMaterialController extends ShiroBaseController<SMchTransmaterial, String, SMchTransmaterialService>{
	
	@Resource
	private SMchTransmaterialService sMchMaterialService;
	
	
	@Value("/stock/smchtransmaterial")
